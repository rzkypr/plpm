    ...
    <form action="{{ route('petugas.store')}} " method="POST" enctype="multipart/form-data">
      ...
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <label class="block text-sm">
          <span class="text-gray-700 dark:text-gray-400">ID User</span>
          <input
            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
            type="text" placeholder="ID User" value="{{ old('nim')}}" name="nim" required></input>
        </label>
        ...
        <label class="block mt-4 text-sm">
          ...
          <input
            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
            type="email" placeholder="email@mail.com" value="{{ old('email')}}" name="email" required></input>
        </label>
        ...
        <label class="block mt-4 text-sm">
          ...
          <input
            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
            type="text" placeholder="08882158789" value="{{ old('phone')}}" name="phone" required></input>
        </label>
